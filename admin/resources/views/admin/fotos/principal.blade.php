        ...
        <div class="col-md-12">
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    ...
                    @else
                        <p>Essa é sua foto principal. Caso queira trocá-la, selecione, apague e envie outra.</p>
                    @endif
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="uploadFotoForm" action="{{ route('fotos.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <img id="fotoPreview" src="#" alt="Pré-visualização da foto" style="display: none; width: 100%; height: auto; margin-top: 10px;">
                                        </div>
                                    </form>
                                </div>
